...
int main(int argc, char* argv[])
{
    ...
    prism::qt::modular::wrapper::startupUrl = "qrc:/rl_gameAgent/views/main.qml";
...
void registerTypes()
{
    ...
    qRegisterMetaType<prism::qt::core::prismModelListProxy<MineCell>*>("prismModelListProxy<MineCell>*");
    qRegisterMetaType<prism::qt::core::prismModelProxy<MineCell>*>("prism::qt::core::prismModelProxy<MineCell>*");
